...
# Example of another input feature (ensure this is consistent with the dataset)
# For simplicity, let's assume Na_to_K (Sodium to Potassium ratio) is the 5th feature
...
if st.button('Predict Drug Today'):
